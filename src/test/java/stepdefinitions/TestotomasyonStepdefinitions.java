...
public class TestotomasyonStepdefinitions {
    ...
    public void urunExcelindekiTumUrunlerIcinAramaYapipMinMiktardaUrunOldugunuTestEder() throws IOException {
        ...
        // eger stok miktarini tutturamayan olursa
        // bunu true yapalim


        // bir loop ile urunu aratip min sayida urun bulundugunu test et
        for (int i = 1; i <=sonSatirIndex ; i++) {
            // once i.index'teki urun ismini ve min urun sayisini excel'den okuyup kaydedelim
            ...
            try {
                ...
                System.out.println("aranan : " + satirdakiUrunIsmi+
                        "min stok sayisindan az bulundu : "
                        +satirdakiMinUrunSayisi +
                        "bulunan urun sayisi : "+
                        actualUrunSayisi);
        ...
        // butun urunler icin Assert yapildiktan sonra eger
        // Failed olan assertion varsa
